...
<body>
	...
	try {
		...
		String rep_login = request.getParameter("rep_name");
		String rep_password = request.getParameter("rep_password");


		//Make an insert statement for the Sells table:
		String search = "CREATE TEMPORARY TABLE result SELECT login_name, password FROM customer_rep WHERE login_name=? and password=?";
		PreparedStatement ps = con.prepareStatement(search);
		ps.setString(1, rep_login);
...
--%>
		...
		<a href="homepg.jsp"><button type="button">Log out</button></a>
</body>
</html>